...
function updateTimer() {
    const targetDate = new Date("january 03, 2025 13:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const recipientNumber1 = '541151518687'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
    // Definir los números de teléfono
    const phoneNumber1 = '541151518687'; // Número para el primer botón
